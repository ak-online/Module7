...
print('Команда Волшебники данных решила задач: {scr}'.format(scr = score_2))
...
# print('I study in {title}-{postfix} {title}'.format(title='Urban', postfix = 'univer'))
# print(f'{"Urban " * 3 } best one forever!')